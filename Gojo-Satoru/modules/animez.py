...
def site_search(update: Update, context: CallbackContext, site: str):
    ...
    if site == "kaizoku":
        ...
        if search_result:
            result = f"<b>Search results for</b> <code>{html.escape(search_query)}</code> <b>on</b> @SHIVANSH474: \n"
            ...
            more_results = False
            result = f"<b>No result found for</b> <code>{html.escape(search_query)}</code> <b>on</b> @SHIVANSH474"
